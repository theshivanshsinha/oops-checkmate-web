      ...
      <div className="w-full max-w-md relative z-10">
        <div ref={formRef} className="bg-white/10 backdrop-blur-xl border border-white/10 shadow-2xl rounded-3xl p-10 animate-fade-in-up">
          <div className="flex flex-col items-center mb-8">
            <ChessLogo />
            <h2 className="text-3xl font-extrabold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mt-4 mb-2 drop-shadow-lg">Join Oops, Checkmate!</h2>
